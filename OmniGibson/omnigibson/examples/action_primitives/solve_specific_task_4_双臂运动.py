...
def main(scene_model=DEFAULT_SCENE_MODEL, scene_file=None, task_config_file=None, short_exec=False):
    """
...
if __name__ == "__main__":
    ...
    main(scene_model=args.scene_model, scene_file=args.scene_file, task_config_file=args.task_config)
